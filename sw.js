...
const CACHE = 'diamond-pages-v22';
const SHELL = ['./', 'index.html', 'styles.css', 'config.js', 'plano.js', 'store.js', 'app.js',
  'vagas-domain.js?v=22','vagas-pdf.js?v=22','vagas.js?v=22','vagas.css?v=22','logo-diamond.png','selo.png', 'wordmark.png', 'pdf-diamond.jpg', 'pdf-domo.jpg', 'icon-192.png', 'icon-512.png', 'manifest.webmanifest'];
