...
const CACHE = 'diamond-pages-v21';
const SHELL = ['./', 'index.html', 'styles.css', 'config.js', 'plano.js', 'store.js', 'app.js',
  'vagas-domain.js?v=21','vagas-pdf.js?v=21','vagas.js?v=21','vagas.css?v=21','logo-diamond.png','selo.png', 'wordmark.png', 'pdf-diamond.jpg', 'pdf-domo.jpg', 'icon-192.png', 'icon-512.png', 'manifest.webmanifest'];
