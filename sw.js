...
const CACHE = 'diamond-pages-v23';
const SHELL = ['./', 'index.html', 'styles.css', 'config.js', 'plano.js', 'store.js', 'app.js','reservas.js?v=23','reservas.css?v=23',
  'vagas-domain.js?v=23','vagas-pdf.js?v=23','vagas.js?v=23','vagas.css?v=23','logo-diamond.png','selo.png', 'wordmark.png', 'pdf-diamond.jpg', 'pdf-domo.jpg', 'icon-192.png', 'icon-512.png', 'manifest.webmanifest'];
